...
public enum StatusCode {
     ...
     */
    SUCCESS(20000, "操作成功"),
    SUCCESS_REGISTER(20001, "注册成功"),
    SUCCESS_LOGIN(20002, "登录成功"),
    SUCCESS_GET_USER(20003, "获取用户信息"),
    SUCCESS_LOGOUT(20004, "退出登录成功"),
    ...
    BAD_LENGTH(40001, "长度太短"),
    BAD_USERNAME_LENGTH(40002, "账号长度太短"),
    BAD_PASSWORD_LENGTH(40003, "密码长度太短"),
    BAD_ADD_USER(40004, "用户添加失败"),
    BAD_UPDATE_USER(40005, "用户修改失败"),
     ...
     * 账号密码不能为空
     */
    PARAMS_REGISTER_NULL(42002, "账号密码不能为空"),
    
    PARAMS_LOGIN_ERROR(42003, "账号或密码错误"),
     ...
     * 账号已存在
     */
    DATA_USERNAME_DUPLICATE(43002, "账号已存在"),
    
    /**
     * 用户不存在
     */
    NOT_FOUND_USER(43003, "用户不存在"),
